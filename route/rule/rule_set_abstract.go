...
func (s *abstractRuleSet) StartContext(ctx context.Context, startContext *adapter.HTTPStartContext) error {
	return nil
}

func (s *abstractRuleSet) PostStart() error {
	return nil
}
...
func (s *abstractRuleSet) Close() error {
	s.rules = nil
	return nil
}
