...
func New(options Options) (*Box, error) {
	...
	if experimentalOptions.Timeout != nil {
		...
		if experimentalOptions.Timeout.TLSFragmentFallbackDelay != 0 {
			C.TLSFragmentFallbackDelay = time.Duration(experimentalOptions.Timeout.TLSFragmentFallbackDelay)
		}
